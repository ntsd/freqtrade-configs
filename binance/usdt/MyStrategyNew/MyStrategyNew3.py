...
# freqtrade hyperopt --hyperopt-loss OnlyProfitHyperOptLoss --spaces buy sell --timeframe 5m -e 2000 --timerange 20210301-20210813 --strategy MyStrategyNew3
...
class MyStrategyNew3(IStrategy):
    ...
    buy_fast_period_30m = IntParameter(5, 50, default=12, space='buy')
    buy_slow_period_30m = IntParameter(5, 50, default=26, space='buy')
    buy_operator_30m = CategoricalParameter(operators.keys(), space='buy')
    sell_fast_period_30m = IntParameter(5, 50, default=12, space='sell')
    sell_slow_period_30m = IntParameter(5, 50, default=26, space='sell')
    sell_operator_30m = CategoricalParameter(operators.keys(), space='sell')
    ...
    buy_fast_period_4h = IntParameter(5, 50, default=12, space='buy')
    buy_slow_period_4h = IntParameter(5, 50, default=26, space='buy')
    buy_operator_4h = CategoricalParameter(operators.keys(), space='buy')
    sell_fast_period_4h = IntParameter(5, 50, default=12, space='sell')
    sell_slow_period_4h = IntParameter(5, 50, default=26, space='sell')
    sell_operator_4h = CategoricalParameter(operators.keys(), space='sell')
