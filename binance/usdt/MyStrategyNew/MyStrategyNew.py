...
# freqtrade hyperopt --hyperopt-loss OnlyProfitHyperOptLoss --spaces buy sell --timeframe 5m --timerange 20210301-20210813 --strategy MyStrategyNew
...
class MyStrategyNew(IStrategy):
    ...
    # Hyperopt parameters
    buy_fast_ema_period = IntParameter(5, 40, default=12, space='buy')
    buy_slow_ema_period = IntParameter(5, 40, default=26, space='buy')
    sell_fast_ema_period = IntParameter(5, 40, default=12, space='sell')
    sell_slow_ema_period = IntParameter(5, 40, default=26, space='sell')
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for info_timeframe in info_timeframes:
            condition, dataframe = self.info_timeframe_condition(
                dataframe, fast_indicator, slow_indicator, info_timeframe)
            conditions.append(condition)
