...
# V4 Update: Optimise hyperops remove operator
...
# freqtrade hyperopt --hyperopt-loss OnlyProfitHyperOptLoss --spaces buy sell --timeframe 5m -e 2000 --timerange 20210301-20210813 --strategy MyStrategyNew5
# freqtrade backtesting --timeframe 5m --timerange 20200807-20210807 --strategy MyStrategyNew5
...
class MyStrategyNew5(IStrategy):
    # ROI table:
    minimal_roi = {"0": 1}
    ...
    def base_timeframe_condition(self, dataframe, fast_indicator, slow_indicator):
        condition = greater_operator(dataframe, fast_indicator, slow_indicator)
        return condition, dataframe
