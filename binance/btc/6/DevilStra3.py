...
class DevilStra3(IStrategy):
    ...
    buy_params = {
        "buy_spell": "Lu,Zi,La,Zi,Cu,De,Ra,Zi,Pa,Ra,Zi,Pa,La,Gu,De,Gu,Ra,La,Lu",
    }

    # Sell hyperspace params:
    sell_params = {
        "sell_spell": "De,Cu,Si,Si,Pa,De,Zi,De,La,Lu,Zi,Zi,Lu,Gu,Cu,Lu,Cu,Gu,Gu",
    }
    ...
    trailing_stop_positive_offset = 0.129
